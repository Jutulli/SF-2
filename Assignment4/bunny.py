...
class Bunny(Mammal, Herbivore, Pet):
    ...
    def sleep(self) -> None:
        print("Bunnies are noctural animals, typically \
sleep around 12 to 14 hours a in short, intermitten periods")

    def reproduce(self) -> None:
        Mammal.reproduce(self)
        print("Bunnies can produce multiple litters per \
year, potentially having 3-8 kits per litter.")

    def eat(self) -> None:
        Herbivore.eat(self)
        print("I mostly eat fresh hay and grass, with some \
leafy greens and a few pellets. I should only be given fruit \
and root vegetables, like carrots, as an occasional treat.")
